...
export const faIR: LocalizationResource = {
  ...
  dates: {
    lastDay: "Yesterday at {{ date | timeString('fa-IR') }}",
    next6Days: "{{ date | weekday('fa-IR','long') }} at {{ date | timeString('fa-IR') }}",
    nextDay: "Tomorrow at {{ date | timeString('fa-IR') }}",
    numeric: "{{ date | numeric('fa-IR') }}",
    previous6Days: "Last {{ date | weekday('fa-IR','long') }} at {{ date | timeString('fa-IR') }}",
    sameDay: "Today at {{ date | timeString('fa-IR') }}",
  },
  dividerText: 'یا',
  ...
  formFieldAction__forgotPassword: 'گذرواژه فراموش کرده اید؟',
  formFieldError__matchingPasswords: 'گذرواژه ها یکسان هستند.',
  formFieldError__notMatchingPasswords: 'گذرواژه ها یکسان نیستند.',
  formFieldError__verificationLinkExpired: 'The verification link expired. Please request a new link.',
  formFieldHintText__optional: 'اختیاری',
  formFieldHintText__slug: 'A slug is a human-readable ID that must be unique. It’s often used in URLs.',
  formFieldInputPlaceholder__backupCode: 'کد پشتیبان وارد کنید',
  formFieldInputPlaceholder__confirmDeletionUserAccount: 'حذف حساب کاربری',
  formFieldInputPlaceholder__emailAddress: 'رایانامه خود را وارد کنید',
  formFieldInputPlaceholder__emailAddress_username: 'رایانامه یا نام کاربری وارد کنید',
  ...
  formFieldInputPlaceholder__password: 'گذرواژه خود را وارد کنید',
  ...
  formFieldLabel__confirmDeletion: 'تائید',
  formFieldLabel__confirmPassword: 'تائید گذرواژه',
  formFieldLabel__currentPassword: 'گذرواژه کنونی',
  formFieldLabel__emailAddress: 'رایانامه',
  formFieldLabel__emailAddress_username:  'رایانامه یا نام کاربری وارد کنید',
  formFieldLabel__emailAddresses: 'رایانامه ها',
  formFieldLabel__firstName: 'نام',
  formFieldLabel__lastName: 'نام خانوادگی',
  formFieldLabel__newPassword: 'گذرواژه جدید',
  ...
  formFieldLabel__password: 'گذرواژه',
  ...
  organizationProfile: {
    ...
    verifyDomainPage: {
      ...
      formTitle: 'کد تائید',
      resendButton:  "کد تائید دریافت نکردید؟ ارسال مجدد",
  ...
  reverification: {
    alternativeMethods: {
      actionLink: 'Get help',
      actionText: 'هیچ کدام از روشها ندارید؟',
      blockButton__backupCode: 'Use a backup code',
      blockButton__emailCode: 'ارسال رایانامه به {{identifier}}',
  ...
  signIn: {
    ...
    alternativeMethods: {
      ...
      subtitle: 'با مشکل مواجه شدید؟ می توانید یکی از این روشها را برای ورود با وبگاه انتخاب کنید.',
      title: 'استفاده از روش دیگر',
    },
    backupCodeMfa: {
    ...
    emailCode: {
      formTitle:'کد تائید',
      resendButton:  "کد تائید دریافت نکردید؟ ارسال مجدد",
      subtitle: 'برای ادامه با {{applicationName}}',
      title: 'بررسی رایانامه',
    },
    emailLink: {
      clientMismatch: {
        subtitle:
    ...
    forgotPassword: {
      formTitle: 'بازنشانی کد گذرواژه',
      resendButton: "کد تایید دریافت نکردید؟ ارسال مجدد",
    ...
    password: {
      ...
      subtitle: 'گذرواژه مرتبط با حساب کاربری خود را وارد کنید',
    ...
    start: {
      ...
      actionText: 'آیا حساب کاربری ندارید؟',
      actionText__join_waitlist: 'Want early access?',
      subtitle: 'سلام مجدد! برای ورود به وبگاه رایانامه خود را وارد کنید',
      subtitleCombined: undefined,
      title: 'ورود به برنامه {{applicationName}}',
      titleCombined: 'ادامه با {{applicationName}}',
    },
    totpMfa: {
      formTitle: 'کد تائید',
  ...
  signUp: {
    continue: {
      actionLink: 'ورود',
      actionText: 'آیا حساب کاربری دارید ؟',
      subtitle: 'Please fill in the remaining details to continue.',
      title: 'Fill in missing fields',
    },
    emailCode: {
      formSubtitle: 'کد تائید که به رایانامه شما ارسال شده را وارد کنید',
      formTitle: 'کد تائید',
      resendButton: "کد تائید دریافت نشده است؟ ارسال مجدد",
      subtitle:  'کد تائید که به رایانامه شما ارسال شده را وارد کنید',
      title: 'تائید رایانامه',
    },
    emailLink: {
      clientMismatch: {
        subtitle:
    ...
    start: {
      ...
      actionText: 'آیا حساب کاربری دارید ؟',
      subtitle: 'خوش آمدید ! لطفا اطلاعات را وارد کنید.',
      subtitleCombined: 'خوش آمدید ! لطفا اطلاعات را وارد کنید.',
  ...
  unstable__errors: {
    ...
    form_param_nil: 'این فیلد مورد نیاز است.',
    form_param_value_invalid: 'The value entered is invalid. Please correct it.',
    form_password_incorrect: 'گذرواژه شما نادرست است. دوباره تلاش کنید.',
    form_password_length_too_short: 'گذروازه خیلی کوتاه است. باید بیشتر از 8 حرف باشد.',
    form_password_not_strong_enough: 'گذرواژه به اندازه کافی قوی نیست.',
    form_password_pwned:
    ...
    passwordComplexity: {
      maximumLength: 'کمتر از {{length}} حرف',
      minimumLength: '{{length}} حرف باشد',
      requireLowercase: 'حروف کوچک',
      requireNumbers: 'یک عدد',
      requireSpecialCharacter: 'یک حرف ویژه',
      requireUppercase: 'یک حرف بزرگ',
      sentencePrefix: 'گذرواژه باید حاوی بیشتر از',
    },
    ...
    zxcvbn: {
      ...
      goodPassword: 'گذروازه همه نیازمندیها را دارد',
      notEnough: 'گذرواژه قوی نیست.',
      suggestions: {
  ...
  userButton: {
    action__addAccount: 'ایجاد حساب کاربری',
    action__manageAccount: 'مدیریت حساب کاربری',
    action__signOut: 'خروج از وبگاه',
    action__signOutAll: 'Sign out of all accounts',
  },
  userProfile: {
